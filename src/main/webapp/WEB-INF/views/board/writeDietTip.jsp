...
<html lang="en">
    ...
    <script type="text/javascript">
	    ...
	    function form_check() {
	    	  ...
	    	  var boardPassword = document.getElementById("password");
		    	...
		    	document.dietTipWriteForm.submit(); //유효성 검사의 포인트 
  ...
  <body>
    ...
    <main>
      ...
      <!-- Help -->
      <form name="dietTipWriteForm" method="post" action="${pageContext.request.contextPath}/board/insert" enctype="multipart/form-data">
                        ...
                        <th>
		                  ...
		                  <div class="input-group mb-1">
		                    ...
		                    <select id="boardKind" name="boardKind" class="js-custom-select u-select-v1 h-50 g-brd-gray-light-v3 g-color-gray-dark-v5 rounded mr-3" style="width:15%;">
		                      <option value="" selected>다이어트꿀팁</option>
		                      <option value="7">칼럼</option>
		                      <option value="8">운동</option>
		                      <option value="9">식단</option>
		                      <option value="10">성공후기</option>
		                    </select>
		                    <div>
