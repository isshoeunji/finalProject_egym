...
<html lang="en">
    ...
    <script type="text/javascript">
	    function form_check() {
	    	  ...
	    	  var boardPassword = document.getElementById("password");
		    	...
		    	document.hometrainingUpdateForm.submit(); //유효성 검사의 포인트 
  ...
  <body>
    ...
    <main>
        ...
        <div class="container">
          <ul class="u-list-inline">
            <li class="list-inline-item g-mr-5">
              <a class="u-link-v5 g-color-text" href="#">홈트레이닝</a>
      ...
      <!-- Help -->
      <form name="hometrainingUpdateForm" method="post" action="${pageContext.request.contextPath}/board/update" enctype="multipart/form-data">
