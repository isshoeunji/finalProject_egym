...
$(function(){
	...
	$("#findIdBtn").click(function(){
		...
		if(!nameCheck){
			...
			$("#findIdForm").attr("action", "/shop/findIdByPhone");
			$("#findIdForm").submit();
		}
			...
			<label class="g-color-gray-dark-v2 g-font-weight-600 g-font-size-14">휴대전화</label>
              ...
              <div class="g-color-gray-dark-v2 g-font-weight-500 g-font-size-13 g-mb-25" id="phoneCheck" style="display:none">※ 인증번호를 발송했습니다.<br>인증번호가 오지 않으면 입력하신 정보가 정확한지 확인하여 주세요.</div>
				...
				<div class="text-center">
			  	  <a class="g-brd-bottom g-brd-gray-dark-v5 g-brd-primary--hover g-color-gray-dark-v5 g-color-primary--hover g-font-weight-600 g-font-size-13 text-uppercase g-text-underline--none--hover" href="page-login-12.html">${count} 이메일로 찾기 >></a>
				</div>
