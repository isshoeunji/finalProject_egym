      ...
      <div class="row justify-content-center">
        <div class="col-sm-8 col-lg-5">
          <div class="g-brd-around g-brd-gray-light-v4 rounded g-py-40 g-px-30">
            ...
            <!-- Form -->
              <form id="loginForm_shop" class="g-py-15" method="post">
                ...
                <div class="g-mb-35">
                  ...
                  <div class="row justify-content-between">
                    ...
                    <div class="col align-self-center text-right">
                      <a class="g-font-size-12" href="${pageContext.request.contextPath}/shop/findId">아이디</a>
                      <a class="g-font-size-12" href="#"> / </a>
                      <a class="g-font-size-12" href="${pageContext.request.contextPath}/shop/findPwd">비밀번호 찾기</a>
                    </div>
                  </div>
                </div>

                <div class="mb-4">
                  <button id="loginBtn_shop" class="btn btn-md btn-block u-btn-primary rounded g-py-13" type="button">로그인</button>
                </div>
              </form>
              <!-- End Form -->
